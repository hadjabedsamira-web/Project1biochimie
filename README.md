...
#4) Ajouter un nouvelle colonne avec des calculs print("****************Ajoute d'une nouvelle colonne****************") 
# Ajouter un nouvelle collone "Catégorie GC" df["Catégorie GC"]=df["Pourcentage GC"].apply(lambda x: "Riche" if x >   
